package net.reinderp.trashcans.common.blocks;
...
import net.reinderp.trashcans.common.blockentities.ItemTrashcanBlockEntity;
import org.apache.logging.log4j.Level;
import org.jetbrains.annotations.Nullable;

import java.util.stream.Stream;

public class ItemTrashcanBlock extends BlockWithEntity {
    public ItemTrashcanBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ItemTrashcanBlockEntity(pos, state);
    }
